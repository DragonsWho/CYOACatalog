...
export default function TagCategory({
  ...
  return (
    // display:flex makes each category row an independent formatting context so rows wrap around
    // the right-floated instructions (compact top rows beside, wide bottom rows full width). mb
    // replaces the parent's gap (now block flow).
