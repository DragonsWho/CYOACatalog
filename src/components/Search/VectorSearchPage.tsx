...
import { Game, gamesCollectionPublic } from '../../pocketbase/pocketbase'; // Импортируем Game и gamesCollectionPublic
...
export default function VectorSearchPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const pbGames = await gamesCollectionPublic.getFullList<Game>({ // getFullList<Game> типизирует результат
        filter: pbFilter,
        expand: 'authors,tags', // Необходимые expand для GameCard
      });
