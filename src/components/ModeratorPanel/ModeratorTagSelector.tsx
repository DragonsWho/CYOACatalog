// Category-aware tag editor for the catalog editor (ModeratorPanel) and the pipeline review queue
// (PipelineReviewPanel). Self-loads categories + tags. `gameTags` is the current selection (only
// .id/.name read, so full Tag objects or trimmed review objects both work). Emits selected ids on
// every change.
