// The reworked "Add a game" page (canonical /create; /add-next redirects). Mobile-first: three
// accordion paths (suggest link / host files / build card) + creator resources.
