// Comment thread selectors (src/components/CyoaPage/Comments):
// textarea[data-testid="comment-input"], button[data-testid="comment-submit"] (Comment/Reply/Save),
// row [data-testid="comment"] with data-comment-id; actions Reply/Edit/Delete then Yes/No.
