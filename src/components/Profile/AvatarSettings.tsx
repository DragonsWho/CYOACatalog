// Avatar pick/upload into users.avatar (same file field Discord OAuth fills). Manually cropped in
// AvatarCropDialog → 256px webp square (tens of KB). authRefresh afterwards so header/chat/comments
// pick it up without reload.
