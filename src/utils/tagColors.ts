// Shared tag colouring for compact category-coloured chips on GameCard and the mobile resting view
// in TagDisplay. Single source — both import from here.
...
// Chip background: tag-specific override, then category default, then neutral fallback.
...
// Gold outline over a category-coloured chip marks a defining ("gold") tag. Distinct from the
// grey-background gold of the interactive voting TagChip.
