...
const themeOptions: ThemeOptions = {
  ...
  components: {
    ...
    // Component style overrides restored from v1.8 (v1.9 removed them by accident).
    MuiTextField: {
      styleOverrides: {
        root: {
    ...
    MuiAppBar: {
      styleOverrides: {
        root: {
          minHeight: '48px',  // default height was 48px in v1.8
        },
      },
    },
    MuiToolbar: {
  ...
  custom: {
    ...
    borderRadius: '3px',
    cardNoiseBackground: `url("${generateCardNoiseBackground()}")`,
    comments: {
