// The isometric six-pip die from the in-game cheat FAB (cheat_shim.js DIE_SVG), reused for the
// "Cheats" button so the entry point matches the tool. Body + pips use currentColor; faces painted
// `faceColor` (FAB red by default).
