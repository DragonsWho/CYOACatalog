// The viewer's PRIVATE builds for this game, pinned above the wall. Public builds are red-framed
// comments in the wall; private ones exist only as `builds` records visible to their owner — this
// strip is the only place they render. Load into the game, publish to the thread, or delete.
