...
export default function AuthorSelector({ value, onChange, availableAuthors, onAuthorsChange }: AuthorSelectorProps) {
  ...
  // Use useMemo to ensure the debounced function isn't recreated on every render
  const debouncedFindSuggestions = useMemo(
    ...
    [availableAuthors, value] // Dependencies: recreate logic if author list or selected values change
  );
