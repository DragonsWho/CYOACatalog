// Hidden page /cheat-lab: host for testing the built-in cheat companion. Loads a hosted game with
// ?__cheat=1 (the Go backend then injects cheat_shim.js into that game's index.html). All cheat UI
// is rendered by the shim inside the iframe (shadow DOM). This page is just a URL box + full-size
// iframe. Nothing touches prod: injection only fires for the flagged URL.
