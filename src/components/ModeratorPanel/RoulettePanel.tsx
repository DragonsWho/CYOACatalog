// /moderator/roulette — bump roulette settings and stats. Backend: bump_roulette.go (GET/POST
// /api/custom/bump/admin, POST .../admin/draw). `enabled` controls the cron itself; other fields
// are gates/cooldowns/limits. "Draw now" runs an extra draw (sets next_draw_at in the past).
