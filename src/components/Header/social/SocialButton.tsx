...
const BaseSocialButton = styled('button', {
  // Don't pass fullWidth to the DOM <button> (React warning).
...
export const getSocialProviderConfig = (provider?: string): SocialProviderConfig => {
  ...
  // hasOwn, not `in`: `in` matches prototype keys (constructor, __proto__) and would return
  // Object's function instead of a config.
  if (Object.prototype.hasOwnProperty.call(SOCIAL_PROVIDER_CONFIGS, normalized)) {
